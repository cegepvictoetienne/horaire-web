...
function App() {
  return (
    <>
      ...
      <footer className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
        <p>
          Ce projet est distribué sous la licence GNU General Public License
          v3.0.
        </p>
        <a
          href="https://github.com/jaixan/horaire-web"
          target="_blank"
